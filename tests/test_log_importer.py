...
class TestParseAuthLine:
    ...
    def test_pam_authentication_failure(self):
        line = (
            "Jan 10 06:55:10 srv sshd[333]: pam_unix(sshd:auth): authentication failure; "
...
class TestImportAuthLog:
    def test_brute_force_detected_from_auth_log(self, tmp_path):
        ...
        summary = import_auth_log(str(log_file), engine=engine, db_path=db_file, default_year=2024)
